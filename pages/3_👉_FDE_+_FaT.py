...
st.write('The partitioning of the total density is not unique, however, the FDE+FaT procedure results in unique subsystem densities as an artifact of the approximate non-additive kinetic energy density functionals.')
